...
public class OCRBatchMain {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      int processedCount = processor.processImages(imageFolder, language, color, guild, outputCsv, date, playerClasses);
   ...
   */
  public int processImages(String imageFolder, String language, String color, String guild, String outputCsv, LocalDate date, Map<String, String> playerClasses) throws Exception {
    ...
    if (tempFile.exists() && tempFile.length() > 0) {
      ...
      List<String> transformedLines = transformCsvLines(csvLines, colorInfo, color, guild, date, playerClasses);
      ...
      try {
        recognition.writeErrorsToFile(dateStr, guild, playerClasses);
      } catch (Exception e) {
  ...
  /**
   * Transform CSV lines by adding date, mapping colors to Suits/Guild, and adding player classes.
   *
   ...
   */
  private List<String> transformCsvLines(List<String> csvLines, List<String> colorInfo, String color, String guild, LocalDate date, Map<String, String> playerClasses) {
    ...
    for (int i = 0; i < csvLines.size(); i++) {
      ...
      if (parts.length >= 6) {
        ...
        // Build new CSV line: date,team,playerName,playerClass,stat1,stat2,...
  ...
  private static void printUsage() {
    ...
    System.out.println("  java OCRBatchMain ./images fra r Dragons results.csv 2025-09-06");
    System.out.println();
